...
SEARCH_FIELDS = (
    ...
    "facility__name",
    "cfo__name",
    # Номер отзываемой доверенности: по «ДОВ-000042» юрист должен находить и
    # саму доверенность, и заявку на её отзыв — иначе связку видно только из
    # карточки.
    "source_request__number",
)
