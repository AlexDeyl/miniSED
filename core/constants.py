...
SYSTEM_PERMISSIONS = [
    ...
    # Сквозной просмотр: владелец права видит ЛЮБЫЕ согласования, заявки,
    # договоры и комплименты, не будучи их инициатором или участником.
    # Право только на чтение — решать и исполнять по-прежнему может лишь тот,
    # кто в маршруте.
    ("view_all", "Просмотр всех документов и заявок", "system"),
]
